package com.adams.scrum.models.vo
{
	...
	public class Stories extends AbstractVO
	{
		...
		public function get themeList():ArrayCollection
		{
			return _themeList;
		}
		
		public function set themeList(value:ArrayCollection):void
		{
			_themeList = value;
		}
		
		public function get themeCollection():ArrayCollection
		{
			return _themeCollection;
		}
		
		public function set themeCollection(value:ArrayCollection):void
		{
		...
		[ArrayElementType("com.adams.scrum.models.vo.Themes")]
		private var _themeCollection:ArrayCollection = new ArrayCollection();
